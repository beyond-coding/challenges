package com.beyondcoding.codingcafe.pickupstation.api.endpoint;
...
import com.beyondcoding.codingcafe.pickupstation.event.Notifier;
...
public class PickUpEndpointTest {
    ...
    public void testUnexpectedProductIsReceived() {
        ...
        assertNull(status);
        verify(notifier, times(0)).notify(any(PurchaseStatus.class));
    }
    ...
    public void testPurchaseWithOneProduct() {
        ...
        verify(notifier).notify(any(PurchaseStatus.class));
    }
